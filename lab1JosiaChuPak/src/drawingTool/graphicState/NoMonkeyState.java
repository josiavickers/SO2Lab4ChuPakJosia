...
public class NoMonkeyState extends State {
	private static NoMonkeyState instance;
	
	private NoMonkeyState(Scene scene) {
		this.scene = scene;
		//noMonkeys = this;
	}

	public static NoMonkeyState getInstance(Scene scene) {
		if (instance == null) {
			instance = new NoMonkeyState(scene);
		}
		return instance;
	}
